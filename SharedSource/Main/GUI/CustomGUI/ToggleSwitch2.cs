...
{
    /// <summary>
    /// ToggleSwitch2 decorate class
    /// </summary>
    public class ToggleSwitch2 : UIBase
    {
        /// <summary>
        /// The instances
        /// </summary>
        ...
        public string OnText
        {
            get
            {
                return this.entity.FindComponent<ToggleSwitchBehavior2>().OnText;
            }

            set
            {
                this.entity.FindComponent<ToggleSwitchBehavior2>().OnText = value;
            }
        }
        ...
        public string OffText
        {
            get
            {
                return this.entity.FindComponent<ToggleSwitchBehavior2>().OffText;
            }

            set
            {
                this.entity.FindComponent<ToggleSwitchBehavior2>().OffText = value;
            }
        }
        ...
        public bool IsOn
        {
            get
            {
                return this.entity.FindComponent<ToggleSwitchBehavior2>().IsOn;
            }

            set
            {
                this.entity.FindComponent<ToggleSwitchBehavior2>().IsOn = value;
            }
        }
        ...
        public ToggleSwitch2(string name)
        {
            this.entity = new Entity(name)
                           ...
                           .AddComponent(new ToggleSwitchBehavior2());
            ...
            // Event
            this.entity.FindComponent<ToggleSwitchBehavior2>().Toggled += this.ToggleSwitch_Toggled;
        }
        #endregion
